...
class AllowDeny
{
	...
	public:
		...
		void	setAccessDirective(const ACCESS_DIRECTIVE access_directive) { this->access_directive_ = access_directive; };
		const static unsigned int	kType_ = CONF_HTTP|CONF_HTTP_SERVER|CONF_HTTP_LOCATION|CONF_HTTP_LIMIT_EXCEPT
