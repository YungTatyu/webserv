 ...
 */
unsigned long Timer::getCurrentTime() { return current_time_; }

int Timer::getFd() const { return this->fd_; }

unsigned long Timer::getRawtime() const { return this->raw_time_ms_; }

unsigned long Timer::getTimeout() const { return this->timeout_ms_; }
...
bool Timer::operator<(const Timer &other) const { return this->timeout_ms_ < other.timeout_ms_; }
