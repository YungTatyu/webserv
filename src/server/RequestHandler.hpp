...
class RequestHandler {
 public:
  ...
  RequestHandler();
  int handleReadEvent(NetworkIOHandler &ioHandler, ConnectionManager &connManager,
  ...
  int handleEofEvent(NetworkIOHandler &ioHandler, ConnectionManager &connManager, ConfigHandler &configHandler, TimerTree &timerTree, const int sockfd);
