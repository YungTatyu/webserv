...
class CGIHandler {
 private:
  ...
  bool forkCgiProcess(const HttpRequest& request, const std::string& script_path, const std::string& path_info);
 ...
 public:
  ...
  bool callCgiExecutor(const std::string& script_path, const std::string& path_info, const HttpRequest& request, const int cli_sock);
