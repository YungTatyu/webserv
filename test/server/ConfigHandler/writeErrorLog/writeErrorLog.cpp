...
TEST(ConfigHandlerTestWriteErrorLog, off) {
  test::ConfigHandlerTest test("writeErrorLog/writeErrLog_test.conf", "127.0.0.1", 8001);
...
TEST(ConfigHandlerTestWriteErrorLog, Default) {
  test::ConfigHandlerTest test("writeErrorLog/writeErrLog_test.conf", "127.0.0.2", 8002);
