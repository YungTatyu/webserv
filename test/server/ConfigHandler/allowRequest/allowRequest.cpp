...
TEST(ConfigHandlerTestAllowRequest, allow_all) {
  ...
  EXPECT_TRUE(test.config_handler_.allowRequest(
      ...
      &test.config_handler_.config_->http_.server_list_[0].location_list_[0], test.request_,
...
TEST(ConfigHandlerTestAllowRequest, deny_all) {
  ...
  EXPECT_FALSE(test.config_handler_.allowRequest(
      test.config_handler_.config_->http_.server_list_[0],
      &test.config_handler_.config_->http_.server_list_[0].location_list_[1], test.request_,
      test.createClient("192.168.0.1")));
}
...
TEST(ConfigHandlerTestAllowRequest, allow_one_address1) {
  ...
  EXPECT_TRUE(test.config_handler_.allowRequest(
      test.config_handler_.config_->http_.server_list_[1],
      &test.config_handler_.config_->http_.server_list_[1].location_list_[0], test.request_,
...
TEST(ConfigHandlerTestAllowRequest, deny_one_address1) {
  ...
  EXPECT_FALSE(test.config_handler_.allowRequest(
      test.config_handler_.config_->http_.server_list_[1],
      &test.config_handler_.config_->http_.server_list_[1].location_list_[1], test.request_,
      test.createClient("192.168.0.2")));
}
...
TEST(ConfigHandlerTestAllowRequest, deny_one_address2) {
  ...
  EXPECT_FALSE(test.config_handler_.allowRequest(
      test.config_handler_.config_->http_.server_list_[2],
      &test.config_handler_.config_->http_.server_list_[2].location_list_[0], test.request_,
...
TEST(ConfigHandlerTestAllowRequest, allow_one_address2) {
  ...
  EXPECT_TRUE(test.config_handler_.allowRequest(
      test.config_handler_.config_->http_.server_list_[2],
      &test.config_handler_.config_->http_.server_list_[2].location_list_[1], test.request_,
