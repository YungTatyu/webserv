...
TEST(allowTest, ipv4) {
  ...
  // server
  test::test_value(server_list[0].allow_deny_list, {"87.65.43.21/32", "87.65.0.21/2"},
                   {config::ALLOW, config::ALLOW});
  test::test_directives_set(server_list[0].directives_set, kAllow, true);
  ...
  test::test_value(server_list[0].location_list[1].allow_deny_list, {"192.0.2.1", "10.0.0.1"},
                   {config::ALLOW, config::ALLOW});
  test::test_directives_set(server_list[0].location_list[0].directives_set, kAllow, true);
  test::test_directives_set(server_list[0].location_list[1].directives_set, kAllow, true);
  ...
  test::test_directives_set(server_list[0].location_list[1].limit_except.directives_set, kAllow, true);
}
...
//
//  // server
//  test::test_value(server_list[0].allow_deny_list, {"::3", "::5", "all"},
//                   {config::ALLOW, config::ALLOW, config::ALLOW});
//  test::test_directives_set(server_list[0].directives_set, kAllow, true);
//
//  // location
...
TEST(allowTest, notFound) {
  ...
  // server
  test::test_directives_set(server_list[0].directives_set, kAllow, false);
  test::test_directives_set(server_list[1].directives_set, kAllow, false);
  test::test_directives_set(server_list[2].directives_set, kAllow, false);

  // location
  test::test_directives_set(server_list[0].location_list[0].directives_set, kAllow, false);
  test::test_directives_set(server_list[1].location_list[0].directives_set, kAllow, false);

  // limit_except
  test::test_directives_set(server_list[0].location_list[0].limit_except.directives_set, kAllow, false);
}
