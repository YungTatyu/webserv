...
TEST(allowTest, ipv4) {
  ...
  // server
  test::test_value(http.server_list[0].allow_deny_list, {"87.65.43.21/32", "87.65.0.21/2"},
  ...
  test::test_value(http.server_list[0].location_list[1].allow_deny_list, {"192.0.2.1", "10.0.0.1"},
                   {config::ALLOW, config::ALLOW});
...
//
//   // server
//   test::test_value(http.server_list[0].allow_deny_list, {"::3", "::5", "all"},
//                    {config::ALLOW, config::ALLOW, config::ALLOW});
//   test::test_directives_set(http.server_list[0].directives_set, kAllow, true);
//
//   // location
...
//                    {config::ALLOW, config::ALLOW, config::ALLOW, config::ALLOW, config::ALLOW});
//   test::test_directives_set(http.server_list[0].location_list[1].limit_except.directives_set, kAllow,
//   true);
// }
