...
TEST(LexerTokenizeTest, events_context) {
  ...
  test::expectSameToken(config::TK_TYPE::TK_STR, "worker_connections", 2, test::getToken(lexer.getTokens(), 2));
...
TEST(LexerTokenizeTest, http_context) {
  ...
  test::expectSameToken(config::TK_TYPE::TK_STR, "/home/student/webserv/html", 8, test::getToken(lexer.getTokens(), 11));
  ...
  test::expectSameToken(config::TK_TYPE::TK_CLOSE_CURLY_BRACE, "}", 14, test::getToken(lexer.getTokens(), 25));
  test::expectSameToken(config::TK_TYPE::TK_CLOSE_CURLY_BRACE, "}", 15, test::getToken(lexer.getTokens(), 26));
  test::expectSameToken(config::TK_TYPE::TK_CLOSE_CURLY_BRACE, "}", 16, test::getToken(lexer.getTokens(), 27));
...
TEST(LexerTokenizeTest, comment_skip) {
  ...
  test::expectSameToken(config::TK_TYPE::TK_STR, "/home/students/webserv/logs/error.log", 7, test::getToken(lexer.getTokens(), 9));
  ...
  test::expectSameToken(config::TK_TYPE::TK_STR, "/home/student/webserv/html", 12, test::getToken(lexer.getTokens(), 17));
  ...
  test::expectSameToken(config::TK_TYPE::TK_CLOSE_CURLY_BRACE, "}", 14, test::getToken(lexer.getTokens(), 22));
  test::expectSameToken(config::TK_TYPE::TK_CLOSE_CURLY_BRACE, "}", 15, test::getToken(lexer.getTokens(), 23));
...
TEST(LexerTokenizeTest, quote_file) {
  ...
  test::expectSameToken(config::TK_TYPE::TK_STR, "/home/students/webserv/logs/error.log", 8, test::getToken(lexer.getTokens(), 12));
  ...
  test::expectSameToken(config::TK_TYPE::TK_STR, "/home/student/webserv/html", 12, test::getToken(lexer.getTokens(), 20));
  test::expectSameToken(config::TK_TYPE::TK_SEMICOLON, ";", 12, test::getToken(lexer.getTokens(), 21));
  test::expectSameToken(config::TK_TYPE::TK_STR, "index index.html;\n\t}\n}", 15, test::getToken(lexer.getTokens(), 22));
